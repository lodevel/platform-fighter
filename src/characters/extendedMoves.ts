...
export const CAT_UP_LIGHT: AttackMoveWithAnimation = {
  ...
  hitbox: { offsetX: 0, offsetY: -22, width: 24, height: 26 },
  startupFrames: 4,
  activeFrames: 2,
  recoveryFrames: 8,
  cooldownFrames: 10,
...
export const CAT_DOWN_LIGHT: AttackMoveWithAnimation = {
  ...
  hitbox: { offsetX: 22, offsetY: 12, width: 26, height: 12 },
  startupFrames: 4,
  activeFrames: 2,
  recoveryFrames: 8,
  cooldownFrames: 9,
...
export const OWL_DOWN_LIGHT: AttackMoveWithAnimation = {
  ...
  hitbox: { offsetX: 26, offsetY: 14, width: 34, height: 14 },
  startupFrames: 5,
  activeFrames: 3,
  recoveryFrames: 10,
  cooldownFrames: 11,
...
export const BEAR_UP_LIGHT: AttackMoveWithAnimation = {
  ...
  hitbox: { offsetX: 0, offsetY: -34, width: 42, height: 36 },
  startupFrames: 8,
  activeFrames: 3,
  recoveryFrames: 14,
  cooldownFrames: 15,
...
export const BEAR_DOWN_LIGHT: AttackMoveWithAnimation = {
  ...
  hitbox: { offsetX: 28, offsetY: 16, width: 40, height: 18 },
  startupFrames: 7,
  activeFrames: 3,
  recoveryFrames: 12,
  cooldownFrames: 14,
