...
const ALL_CHARACTERS: ReadonlyArray<CharacterId> = ['wolf', 'cat', 'owl', 'bear', 'blaze', 'puff', 'aegis', 'volt', 'nova', 'bruno', 'link', 'kirby'];
...
describe('AC 20004 Sub-AC 4 — moveset animation cue catalog', () => {
  describe('Roster coverage', () => {
    ...
    it('flat MOVESET_ANIMATION_CUE_BUNDLES has 120 entries (12 × 10)', () => {
      expect(MOVESET_ANIMATION_CUE_BUNDLES).toHaveLength(120);
    });
