...
import { DONKEYKONG_JAB, DONKEYKONG_TILT, DONKEYKONG_SMASH } from './DonkeyKong';
...
> = Object.freeze({
  ...
  donkeykong: Object.freeze({ jab: DONKEYKONG_JAB, tilt: DONKEYKONG_TILT, smash: DONKEYKONG_SMASH }),
});
